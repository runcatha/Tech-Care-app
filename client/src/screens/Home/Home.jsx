              ...
              <div className='home-logos-desc'>
                <div className='home-vs'>
                  <img src='https://i.imgur.com/28ysAIp.png'
                    ...
                    alt='vs-code'
                    className='vs-image' />
                  <p className='home-paragraph'>Compatible with Visual Studio</p>
                </div>
                ...
                <div className='home-cpu'>
                  <img src="https://i.imgur.com/yraRcoY.png"
                    ...
                    alt='cpu'
                    className='cpu-image' />
                  <p className='home-paragraph'>Intel's i5, i7, or M1 Chip</p>
                </div>
              </div>
            </div>
            <div className='home-mission-statment-link'>
              ...
              <div className='home-browse-selection-link'>
                <Link to='/laptops' id='browse-link' >
                  <h3 className='home-browse-link'>Browse Selection</h3>
                </Link>
              </div>
            </div>
          </div>
